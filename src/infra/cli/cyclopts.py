...
class CycloptsCLIModel(model.CLIModel):
    ...
    def _print_object_getter(object: Type[pydantic.BaseModel]) -> Dict[str, Any]:
        data = {}
        for parameter in libtools.get_parameters_request():
    ...
    def _inject_script(self, script: entrypoint_cli.EntrypointCLI) -> None:
        ...
        async def executor_script() -> None:
            ...
            print("_" * 30)
            request = self._print_object_getter(object=script.cmd.request)
            print("_" * 30)
